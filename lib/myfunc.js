...
// Ported from Levanter's status helpers (lib/functions.js) -- rewritten as
// plain exports so Daratech Bot's command functions can call them directly.
exports.getUptime = (short = false) => {
...
exports.getDate = () => {
    ...
    return { date, time, weekday: now.toLocaleDateString('en-US', { weekday: 'long' }) };
};
